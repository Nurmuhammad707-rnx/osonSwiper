...
const Breadcrumbs = () => {
    ...
    const breadcrumbNameMap = {
        home: language === "RU" ? "Главная" : "Asosiy",
        allProduct: language === "RU" ? "Популярные товары" : "Ommabop mahsulotlar",
        allDrugs: language === "RU" ? "Все лекарства" : "Barcha dori vositalari",
        products: language === "RU" ? "Продукты" : "Mahsulotlar",
        cart: language === "RU" ? "Корзина" : "Savat",
        checkout: language === "RU" ? "Оплата" : "To‘lov",
    };
    return (
