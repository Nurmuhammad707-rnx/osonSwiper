...
function FooterBottom() {
    ...
    return (
        <footer>
            <div className="">
                <h1 className="FooterBottom_title">
                    {language === "RU" ? "Особенности работы справочника лекарств" : "Dori izlash tizimining xususiyatlari"}

                </h1>
                <p className="FooterBottom_text">
                    {language === "RU" ? (
                        <>
                            Справочник лекарств
                            не просто ищет запрашиваемый препарат по аптекам,
                            но и фильтрует полученную информацию по таким критериям:
                        </>
                    ) : (
                        <>
                            Dori izlash tizimi so'ralgan preparatni dorixonalardan izlash bilan cheklanmagan holda, natijani quyidagi mezonlarga muvofiq filtrlaydi:
                        </>
                    )}
            ...
            <div className="all_cards">
                <div className="bottom_FooterBottom">
                    ...
                    <h4 className="FooterBottom_rext">
                        {language === "RU" ? "Ценовая политика: дешевле-дороже;" : "Narx siyosati: arzonroq;"}
                    </h4>
                </div>
                <div className="bottom_FooterBottom">
                    <div className="icon">
                    ...
                    <h4 className="FooterBottom_rext">
                        {language === "RU" ? "Местоположение торговой точки;" : "Savdo nuqtasi joylashuvi: yaqinroq;"}
                    </h4>
                </div>
                <div className="bottom_FooterBottom">
                    <div className="icon">
                    ...
                    <h4 className="FooterBottom_rext">
                        {language === "RU" ? "Сравнение цен двух аналогичных препаратов у разного продавца;" : "Savdo nuqtasi joylashuvi: yaqinroq;"}
                    </h4>
                </div>
                <div className="bottom_FooterBottom">
                    <div className="icon">
                    ...
                    <h4 className="FooterBottom_rext">
                        {language === "RU" ? "Выбор самой близкой аптеки по геолокации пользователя." : "Natijani tanlangan hudud xaritasida ko'rsatish"}
                    </h4>
                </div>
            </div>
            ...
            <h1 className="FooterBottom_bottom-text">
                {language === "RU" ? (
                    ...
                    <>
                        So'ralgan preparat va uning narxidan tashqari, dori izlash tizimi sotuvchi ma’lumoti: yuridik va joylashgan manzili, telefon raqamlari, ish soatlari kabi ma’lumotlarni ham taqdim etadi. Dorixona manziliga etib borishda kerakli ko'cha va binoni izlashga ko'p vaqt ketmasligi uchun xaritada batafsil yo'nalish ko'rsatish ham mumkin.
                    </>
                )}
